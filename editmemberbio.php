...
if(!isset($_GET['Member_ID'])){
    header("refresh: 0; url=http://localhost/member/mainmenu.php");
}
require 'conn.php';
$sql = "SELECT * FROM member WHERE sid='$_GET[Member_ID]'";
...
<body class="container">
    <form id="form1" name="form1" method="post" action="editsuccess.php">
        <p>
            ...
            <input type="text" name="fisrtname" id="fisrtname" value="<?=$row['fisrtname'];?>" />
        </p>
        <p>
